...
class TelemetryCollector:
    ...
    def _load_data(self):
        ...
        try:
            ...
            print(f"Loaded existing telemetry data: {len(self.recommendation_log)} users with recommendations")
    ...
    def save_data(self):
        ...
        with self.lock:
            try:
                ...
                with open(os.path.join(self.data_dir, "recommendations.json"), "w") as f:
