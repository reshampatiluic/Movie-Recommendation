...
def view_model_metrics(model_path="movie_recommender_model.pkl"):
    ...
    try:
        ...
        print(
            f"   Prediction Coverage: {metrics.get('Prediction_Coverage', 'N/A'):.2f}%"
        )

        print("\n2. Training Cost:")
        print(
            f"   Total Training Time: {metrics.get('Total_Training_Time', 'N/A'):.4f} seconds"
        )
        print(
            f"   Similarity Computation Time: {metrics.get('Similarity_Computation_Time', 'N/A'):.4f} seconds"
        )
        ...
        print(
            f"   Utility Matrix Memory: {metrics.get('Utility_Matrix_Memory_MB', 'N/A'):.2f} MB"
        )
        print(
            f"   Similarity Matrix Memory: {metrics.get('Similarity_Matrix_Memory_MB', 'N/A'):.2f} MB"
        )
