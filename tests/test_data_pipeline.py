...
class TestDataPipeline(unittest.TestCase):
    ...
    def load_clean_data(self):
        ...
        df.dropna(subset=["Timestamp_y"], inplace=True)  # Handle missing timestamp issue
        return df
    ...
    def test_no_missing_values(self):
        ...
        self.assertFalse(df.isnull().any().any())  # Should be True only if all missing data is removed
